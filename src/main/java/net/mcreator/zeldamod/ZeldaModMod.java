...
import net.mcreator.zeldamod.init.ZeldaModModSounds;
...
@Mod("zelda_mod")
public class ZeldaModMod {
	public static final Logger LOGGER = LogManager.getLogger(ZeldaModMod.class);
	public static final String MODID = "zelda_mod";

	public ZeldaModMod() {
		MinecraftForge.EVENT_BUS.register(this);
		ZeldaModModTabs.load();
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();
		ZeldaModModSounds.REGISTRY.register(bus);
